const { userSignIn, userRegister, getUser,updateUserDetails,removeProfilePicture, getSuggestedUser, otpSender, forgotPassword, resetPassword, authenticateUser,verifyUserPassword,deleteUserAccount,searchUser,addUsersToFollowingList } = require("../controller/user.controller");
